<%-- 
    Document   : Index
    Created on : 17 nov 2023, 11:16:06
    Author     : jcruz
--%>
...
<html>
    <head>
        <meta charset="utf-8">
    <title>ALDA GYM - Fitness Santa Anita</title>
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            <a href="" class="navbar-brand">
                <h1 class="m-0 display-4 font-weight-bold text-uppercase text-white">ALDA GYM</h1>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4 bg-secondary">
                    ...
                    <a href="feature.html" class="nav-item nav-link">Planes</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu text-capitalize">
                            <a href="blog.html" class="dropdown-item">Planes de Alimentación</a>
                            <a href="single.html" class="dropdown-item">Planes de Entrenamiento</a>
                        </div>
                    </div>
                    <a href="contact.html" class="nav-item nav-link">Contacto</a>
                    <a href="contact.html" class="nav-item nav-link">Iniciar Sesión</a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h3 class="text-primary text-capitalize m-0">Gym & Fitness</h3>
                        <h2 class="display-2 m-0 mt-2 mt-md-4 text-white font-weight-bold text-capitalize">El mejor gimnasio de Santa Anita</h2>
                        <a href="" class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Inicia Ahora</a>
                    </div>
                </div>
